...
func (_m *Repository) Create(d *domain.Photo) (*domain.Photo, error) {
	ret := _m.Called(d)
...
func (_m *Repository) Find(d *domain.Photo) (bool, error) {
	ret := _m.Called(d)
	...
	var r0 bool
	var r1 error
	if rf, ok := ret.Get(0).(func(*domain.Photo) (bool, error)); ok {
		return rf(d)
	}
	if rf, ok := ret.Get(0).(func(*domain.Photo) bool); ok {
		r0 = rf(d)
	} else {
		r0 = ret.Get(0).(bool)
	}
