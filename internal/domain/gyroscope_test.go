...
import (
	entity "github.com/HaroldoFV/desafio/internal/domain"
...
func TestNewGyroscope(t *testing.T) {
	t.Run("Valid Gyroscope", func(t *testing.T) {
		gyro, err := entity.NewGyroscope("MPU-6050", "InvenSense GY-521", "00:11:22:33:44:55")
		require.Nil(t, err)
...
func TestGyroscope_GetMethods(t *testing.T) {
	gyro, _ := entity.NewGyroscope("MPU-6050", "InvenSense GY-521", "00:1A:2B:3C:4D:5E")
	...
	t.Run("GetX", func(t *testing.T) {
		require.Equal(t, 0.0, gyro.GetX())
	})

	t.Run("GetY", func(t *testing.T) {
		require.Equal(t, 0.0, gyro.GetY())
	})

	t.Run("GetZ", func(t *testing.T) {
		require.Equal(t, 0.0, gyro.GetZ())
	})
...
func TestGyroscope_Update(t *testing.T) {
	t.Run("Update with valid data", func(t *testing.T) {
		gyro, _ := entity.NewGyroscope("MPU-6050", "InvenSense GY-521", "00:11:22:33:44:55")
