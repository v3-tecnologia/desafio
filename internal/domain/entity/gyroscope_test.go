...
func TestNewGyroscope(t *testing.T) {
	t.Run("Valid Gyroscope", func(t *testing.T) {
		gyro, err := NewGyroscope("MPU-6050", "InvenSense GY-521", "00:11:22:33:44:55")
		require.Nil(t, err)
...
func TestGyroscope_GetMethods(t *testing.T) {
	gyro, _ := NewGyroscope("MPU-6050", "InvenSense GY-521", "00:1A:2B:3C:4D:5E")
...
func TestGyroscope_Update(t *testing.T) {
	t.Run("Update with valid data", func(t *testing.T) {
		gyro, _ := NewGyroscope("MPU-6050", "InvenSense GY-521", "00:11:22:33:44:55")
